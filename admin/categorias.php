<?php include('header.php'); 
  ...
  if(isset($_POST['pesquisa'])){
    ...
    $query = "SELECT * FROM `categoria` WHERE `nome` LIKE '%$pesquisa%' order by `id` desc";
...
<!-- sidebar-wrapper  -->
  <main class="page-content">
      ...
      <div class="container-fluid">
        <h3 id="titulo-conteudo">Categorias</h3>
        <hr id="divisoria-escura">
        <div class="row" id="sessao-botao-cadastro">
          <div class="col-md-4">
            <!-- Button trigger modal -->
            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#cadastrarCategoria" id="botao-sucesso">
                        ...
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <a href="single-categoria.php?id=<?php echo $key['id']; ?>" class="btn btn-outline-dark" id="botao-sucesso">Ver Produtos Da Categoria</a>
                                </div>
                            </div>
                        </div>
                    </div>
