<?php include('header.php'); 
  ...
  if(isset($_POST['pesquisa'])){
    ...
    $query = "SELECT * FROM `produto` WHERE `nome` LIKE '%$pesquisa%' or `categoria` LIKE '%$pesquisa%' order by `id` desc";
    ...
    $produtos = selecionarTodosProdutos($conexao);
  }

  $categoria = selecionarTodasCategorias($conexao);
...
<!-- sidebar-wrapper  -->
  <main class="page-content">
      ...
      <div class="container-fluid">
        <h3 id="titulo-conteudo">Produtos</h3>
            ...
            <div class="row">
              <div class="col-md-8">
                <div class="form-group">
                  <input type="text" name="pesquisa" id="input-black-painel" placeholder="Busque por produto ou categoria" class="form-control">
                </div>
              </div>
              <div class="col">
                <div class="form-group">
                        ...
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <p class="card-text"><a href="categoria-single.php?id=<?php echo $key['id_categoria'] ?>"><?php echo $key['categoria']; ?></a></p>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="cadastrar-produto.php" method="POST" id="formulario-reg-log" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <label for="nome" id="label-pequeno-painel">Categoria</label>
            <select class="form-control" id="input-black-painel" name="categoria" required>
              <option value="">Selecione uma categoria para o produto</option>
              <?php foreach ($categoria as $cat) {?>
                <option value="<?php echo $cat['id']; ?>"><?php echo $cat['nome']; ?></option>
              <?php  } ?>
            </select>
            <a href="categorias.php">Não encontrou a categoria? Cadastre uma nova aqui</a>
          </div>
          <div class="form-group">
            <label for="nome" id="label-pequeno-painel">Foto principal do produto</label>
