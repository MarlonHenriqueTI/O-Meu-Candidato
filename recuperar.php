...
$body = "===================================" . "\n";
$body = $body . "O Meu Candidato" . "\n";
$body = $body . "===================================" . "\n\n";
$body = $body . "Esqueceu sua senha? Sem problemas segue o link para recuperar sua senha:\n"; //Aqui vai o telefone no e-mail
$body = $body . "Link: http://omeucandidato.com/nova-senha.php?email=" . $email . "\n";
$body = $body . "===================================" . "\n";

// envia o email
mail($destinatario, 'O Meu Candidato - Recuperar Senha' , $body, "From: O Meu Candidato!\r\n");
